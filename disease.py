...
for x in range(0,len(l1)):
    l2.append(0)                                                #all element of l2 becomes 0 till length of l1
                       ...
                       # TESTING DATA
test=pd.read_csv("https://raw.githubusercontent.com/Vedica1228/Disease-Prediction/main/testing.csv")              #reading csv file by pd
...
# TRAINING DATA
train=pd.read_csv("https://raw.githubusercontent.com/Vedica1228/Disease-Prediction/main/training.csv")
...
VedicaGUI = Tk()
VedicaGUI.title(" Disease Prediction Based on Symptoms")
VedicaGUI.configure()
...
S1En = OptionMenu(VedicaGUI, Symptom1, *OPTIONS)
S1En.grid(row=7, column=2)

S2En = OptionMenu(VedicaGUI, Symptom2, *OPTIONS)
S2En.grid(row=8, column=2)

S3En = OptionMenu(VedicaGUI, Symptom3, *OPTIONS)
S3En.grid(row=9, column=2)

S4En = OptionMenu(VedicaGUI, Symptom4, *OPTIONS)
S4En.grid(row=10, column=2)

S5En = OptionMenu(VedicaGUI, Symptom5, *OPTIONS)
S5En.grid(row=11, column=2)

NameLb = Label(VedicaGUI, text="")
...
t3 = Text(VedicaGUI, height=2, width=30, bg="grey")
